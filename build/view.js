...
/***/ "./src/Components/Backend/Themes/Default.js":
/*!**************************************************!*\
  !*** ./src/Components/Backend/Themes/Default.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Default = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    $(`#${id} .content`).textillate((0,_utils_config__WEBPACK_IMPORTED_MODULE_1__.textillateConfig)(attributes));
  ...
  }, prefixText), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "content"
  }, content), suffixText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
...
const Style = ({
  ...
  const mainSl = `#${id}`;
  const animatedTextSl = `#${id} .${_utils_data__WEBPACK_IMPORTED_MODULE_3__.prefix}`;
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', typography)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${animatedTextSl} .content`, typography, options?.theme === 'type7' ? false : true)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${defaultPrefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${defaultSuffixSl}`, suffixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${prefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${suffixTextSl}`, suffixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeTwoPrefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeTwoSuffixSl}`, suffixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeThreePrefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeThreeSuffixSl}`, suffixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeFourPrefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeFourSuffixSl}`, suffixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeFivePrefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeFiveSuffixSl}`, suffixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeSixPrefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeSixSuffixSl}`, suffixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeSevenPrefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeSevenSuffixSl}`, suffixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeNinePrefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeNineSuffixSl}`, suffixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeTenPrefixSl}`, prefixTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${typeTenSuffixSl}`, suffixTypo)?.styles}
		...
		${animatedTextSl} .content{
			...
			${isTextShadow ? `text-shadow: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(textShadow, 'text')};` : ""}
		}
		${typeTwoSl}{
			justify-content: ${textAlignment}
		}
		...
		${typeNineSl},
		${typeTenSl}{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('width', animatedSize?.width['desktop'])}
		}

		${typeOneSl}{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('height', animatedSize?.height['desktop'])}
		}
		...
		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.tabBreakpoint}{
			...
			${typeNineSl},
			${typeTenSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('width', animatedSize?.width['tablet'])}
			}
		}

		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.tabBreakpoint}{
			${typeOneSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('height', animatedSize?.height['tablet'])}
			}
		}
		...
		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.mobileBreakpoint}{
			...
			${typeNineSl},
			${typeTenSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('height', animatedSize?.width['mobile'])}
			}
		}

		${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_1__.tabBreakpoint}{
			${typeOneSl}{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)('height', animatedSize?.height['mobile'])}
			}
		}
...
/***/ "./src/Components/Common/Themes/TypeEight.js":
/*!***************************************************!*\
  !*** ./src/Components/Common/Themes/TypeEight.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TypeEight = ({
  ...
  const texts = content.split('|').map(text => text.trim()).filter(Boolean);
  const [displayText, setDisplayText] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const [textIndex, setTextIndex] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  const [cycle, setCycle] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0); // only for single text repeat
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    return () => clearInterval(typingInterval);
  }, [textIndex, cycle, fullText, typingSpeed, reStartTime, autoRepeat, texts.length]);
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "content"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "stage"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "type8-line"
  }, prefixText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "atb-prefix"
  }, prefixText, ' '), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "atb-typing-text"
  }, displayText, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "cursor"
  })), suffixText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "atb-suffix"
  }, ' ', suffixText))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeEight);

/***/ }),

/***/ "./src/Components/Common/Themes/TypeFive.js":
/*!**************************************************!*\
  !*** ./src/Components/Common/Themes/TypeFive.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TypeFive = ({
  ...
  const loopCountRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(repeatBehavior);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const renderSentence = text => {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(".char", {
        scaleX: 1,
        scaleY: 1,
        opacity: 1
      });
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "prefix-text"
  }, prefixText), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wrapper"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeFive);

/***/ }),

/***/ "./src/Components/Common/Themes/TypeFour.js":
/*!**************************************************!*\
  !*** ./src/Components/Common/Themes/TypeFour.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TypeFour = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    let gtl = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline({
      yoyo: true,
      repeat: -1,
      delay: 0
    });
    function animateText() {
      let tl = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline().to(".char", {
        fontStretch,
        ease: "sine.inOut",
        duration: animationDuration,
        stagger: {
          each: 0.2,
          // Speed up the stagger to get more fluidity
          yoyo: true,
          // Makes the animation reverse back after each cycle
          repeat: -1 // Repeats the animation infinitely
        },
        opacity: 1,
        // Make the characters visible as they animate
        x: i => Math.sin(i * 0.5) * waveEffect // Moves characters left-right with sin function for wave effect
      }).to(".char", {
        fontStretch: "100%",
        // Shrinks the fontStretch back
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeFour);

/***/ }),

/***/ "./src/Components/Common/Themes/TypeNine.js":
/*!**************************************************!*\
  !*** ./src/Components/Common/Themes/TypeNine.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TypeNine = ({
  ...
  const textRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const offscreenTextRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const lettersRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)([]);
  const [sentenceIndex, setSentenceIndex] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  const [isAnimating, setIsAnimating] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const [cycle, setCycle] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);

  // 🔹 split sentences
  const sentences = content.split("|").map(t => t.trim()).filter(Boolean);
  ...
  const animateLetterIn = letter => {
    const yOffset = (0.5 + Math.random() * 0.5) * 50;
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo(letter, {
      scale: 0,
      opacity: 0
    }, {
      scale: 1,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(letter, {
      y: -yOffset,
      duration: 0.2,
      ease: "power3.inOut",
      yoyo: true,
  ...
  const generateConfetti = letter => {
    for (let i = 0; i < 10; i++) {
      ...
      confetti.style.left = `${rect.left + rect.width / 2}px`;
      confetti.style.top = `${rect.top + rect.height / 2 + window.scrollY}px`;
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(confetti, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeNine);

/***/ }),

/***/ "./src/Components/Common/Themes/TypeOne.js":
/*!*************************************************!*\
  !*** ./src/Components/Common/Themes/TypeOne.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TypeOne = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    timeline.set(chars, {
      ...
      rotationY: "-=360",
      // Rotate circularly
      duration: animationSpeed || 16,
      // Use animationSpeed from settings or default
      ease: "none",
      repeat: -1
    });
    if (enableOscillation) {
      timeline.fromTo(chars, {
        ...
        rotationX: 12,
        // Oscillation along X-axis
        duration: 6,
        ease: "power3.inOut",
        yoyo: true,
        repeat: repeatBehavior || -1
      }, 0).fromTo(textElement, {
        rotation: 20
      },
      // Oscillate the entire text
      {
        rotation: -10,
        duration: 10,
        ease: "power2.inOut",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeOne);

/***/ }),

/***/ "./src/Components/Common/Themes/TypeSeven.js":
/*!***************************************************!*\
  !*** ./src/Components/Common/Themes/TypeSeven.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TypeSeven = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (textElement) {
      ...
      let gtl = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
        yoyo: true,
        repeat: repeatAnimate,
        delay: 0
      });
      const animateText = () => {
        return gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline().to(".char", {
          fontStretch: "10%",
          ease: "sine.inOut",
          duration: animationDuration,
          stagger: {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__["default"].to(content, {
        autoAlpha: 1,
        duration: 4,
        ease: "none"
      });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeSeven);

/***/ }),

/***/ "./src/Components/Common/Themes/TypeSix.js":
/*!*************************************************!*\
  !*** ./src/Components/Common/Themes/TypeSix.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TypeSix = ({
  ...
  const repeatCountRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(0);
  const timerRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const sentences = content.split(" | ").map(s => s.trim()).filter(Boolean);
  const [sentenceIndex, setSentenceIndex] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  const [chars, setChars] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    timerRef.current = setTimeout(() => {
      ...
      // ✅ repeat = true
      if (sentences.length > 1) {
        setSentenceIndex(prev => prev === sentences.length - 1 ? 0 : prev + 1);
      } else {
  ...
  /* GSAP animation */
  const animateText = () => {
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].set(stageRef.current, {
      autoAlpha: 1
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].from(stageRef.current.querySelectorAll(".char"), {
      duration: 2,
      y: -500,
      fontWeight: 700,
      fontStretch: 80,
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "txt"
  }, chars.map((char, i) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    key: i,
    className: "char"
  }, char === " " ? "\u00A0" : char)))), suffixText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "suffix-text"
  }, suffixText));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeSix);

/***/ }),

/***/ "./src/Components/Common/Themes/TypeTen.js":
/*!*************************************************!*\
  !*** ./src/Components/Common/Themes/TypeTen.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TypeTen = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "prefix-text"
  }, prefixText), "wave" === animateType && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "content"
  }, `${content}`.split('').map((letter, i) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    key: i,
    className: "animate-wave",
    style: {
      animationDelay: `${i * 0.1}s`
    }
  }, letter))), "bounce" === animateType && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "content animate-bounce-text"
  }, content), "glitch" === animateType && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "content animate-glitch"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeTen);

/***/ }),

/***/ "./src/Components/Common/Themes/TypeThree.js":
/*!***************************************************!*\
  !*** ./src/Components/Common/Themes/TypeThree.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TypeThree = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const sentences = content.split("|").map(s => s.trim()).filter(Boolean);
    const timeline = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.timeline({
      repeat: repeatBehavior,
      // Repeats animation twice
    ...
    sentences.forEach((sentence, sentenceIndex) => {
      ...
      words.forEach(word => {
        ...
        wordElement.style.textShadow = isTextShadow && (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getMultiShadowCSS)(textShadow, "text");
        container.appendChild(wordElement);
        gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.set(wordElement, {
          autoAlpha: 0,
          scale: 0
        });
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `content align-${textAlignment}`
  }, prefixText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "prefix-text"
  }, prefixText), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "animated-wrapper"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeThree);

/***/ }),

/***/ "./src/Components/Common/Themes/TypeTwo.js":
/*!*************************************************!*\
  !*** ./src/Components/Common/Themes/TypeTwo.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    sentences.forEach(sentence => {
      timeline.add(() => {
        ...
        switch (animationEffect) {
          case "default":
            gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from(chars, {
              duration: animationSpeed,
              opacity: 0,
              scale: 0,
              y: 80,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TypeTwo);

/***/ }),

/***/ "./src/Components/Frontend/Themes/ThemeSwitch.js":
/*!*******************************************************!*\
  !*** ./src/Components/Frontend/Themes/ThemeSwitch.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Backend_Themes_Default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Backend/Themes/Default */ "./src/Components/Backend/Themes/Default.js");
/* harmony import */ var _Common_Themes_TypeOne__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Common/Themes/TypeOne */ "./src/Components/Common/Themes/TypeOne.js");
/* harmony import */ var _Common_Themes_TypeTwo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../Common/Themes/TypeTwo */ "./src/Components/Common/Themes/TypeTwo.js");
/* harmony import */ var _Common_Themes_TypeThree__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../Common/Themes/TypeThree */ "./src/Components/Common/Themes/TypeThree.js");
/* harmony import */ var _Common_Themes_TypeFour__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../Common/Themes/TypeFour */ "./src/Components/Common/Themes/TypeFour.js");
/* harmony import */ var _Common_Themes_TypeFive__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../Common/Themes/TypeFive */ "./src/Components/Common/Themes/TypeFive.js");
/* harmony import */ var _Common_Themes_TypeSix__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../Common/Themes/TypeSix */ "./src/Components/Common/Themes/TypeSix.js");
/* harmony import */ var _Common_Themes_TypeSeven__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../Common/Themes/TypeSeven */ "./src/Components/Common/Themes/TypeSeven.js");
/* harmony import */ var _Common_Themes_TypeEight__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../Common/Themes/TypeEight */ "./src/Components/Common/Themes/TypeEight.js");
/* harmony import */ var _Common_Themes_TypeNine__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../Common/Themes/TypeNine */ "./src/Components/Common/Themes/TypeNine.js");
/* harmony import */ var _Common_Themes_TypeTen__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../Common/Themes/TypeTen */ "./src/Components/Common/Themes/TypeTen.js");
...
const ThemeSwitch = props => {
  ...
  switch (theme) {
    case 'default':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Backend_Themes_Default__WEBPACK_IMPORTED_MODULE_1__["default"], {
        attributes: attributes,
        id: id
      });
    case 'type1':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeOne__WEBPACK_IMPORTED_MODULE_2__["default"], {
        attributes: attributes
      });
    case 'type2':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeTwo__WEBPACK_IMPORTED_MODULE_3__["default"], {
        attributes: attributes
      });
    case 'type3':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeThree__WEBPACK_IMPORTED_MODULE_4__["default"], {
        attributes: attributes
      });
    case 'type4':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeFour__WEBPACK_IMPORTED_MODULE_5__["default"], {
        attributes: attributes
      });
    case 'type5':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeFive__WEBPACK_IMPORTED_MODULE_6__["default"], {
        attributes: attributes
      });
    case 'type6':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeSix__WEBPACK_IMPORTED_MODULE_7__["default"], {
        attributes: attributes
      });
    case 'type7':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeSeven__WEBPACK_IMPORTED_MODULE_8__["default"], {
        attributes: attributes
      });
    case 'type8':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeEight__WEBPACK_IMPORTED_MODULE_9__["default"], {
        attributes: attributes
      });
    case 'type9':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeNine__WEBPACK_IMPORTED_MODULE_10__["default"], {
        attributes: attributes
      });
    case 'type10':
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Common_Themes_TypeTen__WEBPACK_IMPORTED_MODULE_11__["default"], {
        attributes: attributes
      });
    default:
      return null;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   textillateConfig: () => (/* binding */ textillateConfig),
...
const textillateConfig = attributes => {
  const {
    loop,
    animateIn,
    inEffect,
  ...
  return {
    ...
    in: {
      ...
      delayScale: 1.5,
      delay: 50,
      sync: 'sync' === inSequence,
      // sequence of char/word
      shuffle: 'shuffle' === inSequence,
      // (doesn't make sense with sync = true)
...
const themeSwitch = (theme = "default", attributes) => (0,immer__WEBPACK_IMPORTED_MODULE_0__.produce)(attributes, draft => {
  ...
  switch (theme) {
    case 'default':
      ...
      draft['animatedSize']['width'] = {
        'desktop': '100%',
        'tablet': '',
        'mobile': ''
      };
      draft['animatedSize']['height'] = {
        'desktop': '',
        'tablet': '',
        'mobile': ''
      };
      ...
      draft['gsapAnimation']['textShadow'] = [{
        "blur": "5px",
        "color": "#A4A4A4",
        "hOffset": "2px",
        "isInset": false,
    ...
    case 'type3':
      ...
      draft['gsapAnimation']['randomColor'] = false, draft['gsapAnimation']['customColor'] = false;
    ...
    case 'type9':
      ...
      draft['gsapAnimation']['animationSpeed'] = 1;
      draft['gsapAnimation']['repeatDelay'] = 1;
      draft['gsapAnimation']['randomColor'] = true, draft['gsapAnimation']['customColor'] = false;
      draft['gsapAnimation']['isTextShadow'] = false;
      draft['gsapAnimation']['textShadow'] = [{
        "blur": "19px",
        "color": "rgba(39, 195, 130, 1)",
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   animatedIcon: () => (/* binding */ animatedIcon),
/* harmony export */   animatedTextDocs: () => (/* binding */ animatedTextDocs),
/* harmony export */   dashPrefix: () => (/* binding */ dashPrefix),
/* harmony export */   docsURL: () => (/* binding */ docsURL),
/* harmony export */   pluginSlug: () => (/* binding */ pluginSlug),
/* harmony export */   prefix: () => (/* binding */ prefix),
/* harmony export */   pricingPage: () => (/* binding */ pricingPage),
/* harmony export */   siteURL: () => (/* binding */ siteURL)
/* harmony export */ });
const prefix = 'atbAnimatedText';
const pluginSlug = 'animated-text-block';
const siteURL = 'https://bblockswp.com/';
const docsURL = `${siteURL}docs/`;
const animatedTextDocs = `${docsURL}animated-text-block/`;
const dashPrefix = 'bplDashboard';
const animatedIcon = 'https://ps.w.org/animated-text-block/assets/icon-128x128.png?rev=2647126';
const pricingPage = `${location.origin}/wp-admin/edit.php?post_type=animated-text-block&page=atb_demo_page#/pricing`;
