...
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router/dist/development/chunk-IR6S3I6Y.mjs");
...
/* harmony import */ var _Layout_Layout__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Layout/Layout */ "./dashboard/Layout/Layout.js");
/* harmony import */ var _utils_data__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utils/data */ "./dashboard/utils/data.js");
...
const App = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_10__.HashRouter, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_10__.Routes, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_10__.Route, {
    path: "/",
    element: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Layout_Layout__WEBPACK_IMPORTED_MODULE_8__["default"], {
      ...props
    })
  ...
  }), hasPro && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_10__.Route, {
    path: "activation",
    ...
    element: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_bpl_tools_Admin_Settings__WEBPACK_IMPORTED_MODULE_7__["default"], {
      ...props,
      ajaxAction: "atbSaveUninstallOption"
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_10__.Route, {
    path: "*",
...
const welcomeInfo = (adminUrl = '') => ({
  ...
  gettingStarted: {
    tabs: [{
      ...
      steps: [{
        ...
        link: {
          url: `${adminUrl}post-new.php?post_type=animated-text-block`,
          label: 'Add New'
        }
      }, {
        num: 2,
        ...
        link: {
          url: `${adminUrl}edit.php?post_type=animated-text-block`,
          label: 'All Items'
        }
      }, {
        num: 4,
  ...
  changelogs: [{
    ...
    type: 'update',
    list: ['<strong>Update:</strong>Added a modern  dashboard layout.']
  }, {
    version: '1.2.4 - 21 Feb, 2026',
    type: 'update',
    list: ['<strong>Update:</strong>ProModal alert import from bpl-tools.', '<strong>Fix:</strong> Admin dashboard data set error issue fixed.']
  }, {
    version: '1.2.3 - 14 Feb, 2026',
    type: 'update',
    list: ['<strong>Update:</strong> Dashboard menu item name set the rename.']
  }, {
    version: '1.2.2 - 14 Feb, 2026',
    type: 'new',
    list: ['<strong>New:</strong> Instantly switch between predefined appearances.']
  }, {
    version: '1.2.1 - 8 Feb, 2026',
    type: 'update',
    list: ['<strong>Update:</strong> Some style customization.', '<strong>Update:</strong> Pro modal, Pro selector, and Pro selector layout renamed and upgraded.', '<strong>New:</strong> Added prefix/suffix content and multiple sentences to animate one by one.']
  }, {
    version: '1.1.9 - 15 Nov, 2025',
    type: 'update',
    list: ['<strong>Update:</strong> Freemius SDK updated to the latest version.', '<strong>New:</strong> Demo created for this plugin.']
  }, {
    version: '1.8.0 - 10 Nov, 2025',
    type: 'fix',
    list: ['<strong>Fix:</strong> Support translator issue fixed.']
  }],
  changelogsLimit: 6,
  changelogsReadMoreLabel: 'View More Changelogs',
  proFeatures: ['Choose from a variety of pre-designed themes for unique text animations', 'Allows you to display and animate multiple text lines in sequence', 'Access premium animation styles for stunning visuals', 'Fine-tune the speed of text animations for better effects', 'Choose from a wide range of fonts, colors, and text styles to match your brand', 'Enhance 3D effects with adjustable perspective depth', 'Add dynamic motion with oscillating text effects', 'Automatically loop animations for continuous display']
});
const demoInfo = {
...
/* harmony import */ var _bpl_tools_Admin_style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../bpl-tools/Admin/style.scss */ "../bpl-tools/Admin/style.scss");
/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./App */ "./dashboard/App.js");
/* harmony import */ var _utils_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/data */ "./dashboard/utils/data.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  react_dom__WEBPACK_IMPORTED_MODULE_1___default().createRoot(adminEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_App__WEBPACK_IMPORTED_MODULE_3__["default"], {
